...
def train(args):
    ...
    model = SpamBiLSTM(len(vocab), args.embed_dim, args.hidden_dim,
    ...
    with open(str(ARTIFACTS / "results.json"), "w") as f:
        json.dump({"val_f1": best_f1, "test_f1": tf1}, f)
